      ...
      >
        ...
        >
          <Container as={Stack} maxW="7xl" py={10}>
            <SimpleGrid columns={[1, 2, 4, 4]} spacing={15}>
              <Stack alignItems={['center', 'flex-start']} fontFamily="ABScript" align={['center', 'flex-start']}>
              ...
              <Stack alignItems={['center', 'center', 'flex-start']} border={'0px solid red'}>
                <Goto to="/">
                  <Image height="150px" marginLeft="-5px" src="https://i.ibb.co/GT0wDv2/fashion1.jpg" alt="logo" />
                </Goto>
              </Stack>
            </SimpleGrid>
          </Container>
          <hr />
          <Flex gap={['0', '0', '25%']} color="black" justifyContent={['center', 'center', 'space-around', 'space-around', 'space-around']} direction={['column', 'column', 'row']}>
            <Flex>
              <Text fontSize="md">
