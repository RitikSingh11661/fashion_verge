...
export const reducer = (state = initialState, { type, payload }) => {
   switch (type) {
      ...
      case GET_CAROSELS_DATA_REQUEST: return { ...state, isLoading: true };
      case GET_CAROSELS_DATA_SUCCESS: return { ...state, isLoading: false, allcarosels: { ...payload }, isError: false };
      case GET_CAROSELS_DATA_FAILURE: return { ...state, isLoading: false, isError: true };
