        ...
        boxShadow='rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset'>
                    ...
                    <Box display="flex" gap="10px">
                        ...
                        <Box padding={'20px'}>
                           ...
                           <Text mt='10px' fontWeight={'600'} fontSize={'16px'} textAlign={'left'}>Price: ₹ {data.price}</Text>
                            <Button variant={'unstyled'} pt={'5px'} fontSize={'18px'} onClick={()=>deleteCart(data._id)}><RiDeleteBin6Line/></Button>
                           </Box>                            
                        </Box>
                    </Box>
                </Box>
                ...
                <Box w="100px">
                    ...
                    <Box bgColor={'#ececec'} boxShadow='rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset' display="flex" borderRadius={'5px'}>
                        ...
                        <Button bg="none" isDisabled={data.quantity==1? true:false} onClick={()=>handleQuantity(data._id,'dec')}>-</Button>
                    </Box>
                </Box>
                <Box mr='20px' fontWeight="bold"><Text>Total: ₹ {data.quantity*data.price}</Text></Box>
        </Box>
